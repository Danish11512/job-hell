# workatastartup - Deep Research: extractors for a filterable job list

STATUS: pending deep research.

## Goal
Find what extractors/selectors/endpoints are available on workatastartup (YC) to pull job
